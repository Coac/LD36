...
function EnemyManager:new()
  local o = {
   ...
   table.insert(o.waves, Wave:new({Enemy, Enemy2}, 5, 0.3))
   table.insert(o.waves, Wave:new({Enemy2, Enemy3, Enemy}, 10, 0.4))
   table.insert(o.waves, Wave:new({Enemy3, Enemy4, Enemy}, 10, 0.3))
   table.insert(o.waves, Wave:new({Enemy4, Enemy5}, 10, 0.3))
   table.insert(o.waves, Wave:new({Enemy6}, 10, 0.3))
   table.insert(o.waves, Wave:new({Enemy7}, 10, 0.5))
